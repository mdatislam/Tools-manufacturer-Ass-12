...
const Products = () => {
    ...
    return (
        <div className='container mx-auto mt-4 py-4'>
            ...
            <p className='text-center'>The manufacture of industrial equipment requires a vast knowledge base of <br/>processes and understanding of fundamental concepts.</p>
