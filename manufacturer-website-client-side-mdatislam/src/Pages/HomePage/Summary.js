...
const Summary = () => {
  return (
    <div>
      <div class="stats shadow mt-6 py-10 bg-slate-200 mb-8 container mx-auto ml-4 bg-[#353535] flex flex-col md:flex-row">
        <div class="stat flex flex flex-row justify-center ">
